...
def purchase(List):
    ...
    print("\nHello " + a_name + "! Welcome to our Shopping Center.\nPlease select product as per your choice.")
    ...
    while flag.upper() == "Y":  # check and go if flag is 'Y' or 'y'.
        ...
        if product_name == L[0][0].upper() \
            ...
            elif product_name == L[1][0].upper():
                q[product_name] = p_quantity
            elif product_name == L[2][0].upper():
                q[product_name] = p_quantity
            else:
                print("Enter the product that is available in our store.\n")
    ...
    '''
        In the following operation:
        Check the total purchase amount which is basic discountable or not.
    '''
    dis = 0.0
    if (f_amount >= 5000) and (f_amount < 10000):
        ...
        print("You got 5% discount and discounted amount is:", dis)
    elif f_amount >= 10000:
        discount = 10.0
        dis = (discount * f_amount) / 100
        total = float(f_amount - dis)
        print("You got 10% discount and discounted amount is:", dis)
    else:
        discount = 0.0
    ...
    import datetime  # import system date and time for create a unique invoice name.
